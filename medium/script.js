...
// 1) if the number is included in the array return the index

let indexOfArray = function (array, tgt) {
  if (array.includes(tgt)) {
    console.log(array.indexOf(tgt));
  } else {
    console.log(-1);
  }
};

indexOfArray([4, 5, 6, 7, 0, 1, 2], 7);
indexOfArray([4, 5, 6, 7, 0, 1, 2], 3);
